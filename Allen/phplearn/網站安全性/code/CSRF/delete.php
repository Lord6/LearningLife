...
if(isset($_GET["delete"])){
	...
	print "<script lanuage='javascript'>location.href='http://localhost/webinjection/CSRF/select.php'</script>";
}
...
<html>
<body>
<form method="get" action="http://localhost/webinjection/CSRF/delete.php">
<?php 	
